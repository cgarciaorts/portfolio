print("_________________Agenda________________")
...
while True:
    ...
    if opcion == 1:
        ...
        if nombre in agenda:
            print(" ya existe su número de teléfono es ", (nombre,agenda[nombre]))
        ...
        for nombre, numero in agenda.items():
            if nombre.startswith(cadena):
                print("El número de teléfono de  es el ",(nombre,agenda[nombre]))
    elif opcion == 3:
